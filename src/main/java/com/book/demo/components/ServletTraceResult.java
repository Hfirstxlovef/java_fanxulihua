...
public class ServletTraceResult {
    private final List<ComponentExecutionStep> executionSteps;
    private final ServletSecurityAssessment securityAssessment;
    private final long executionTime;
    
    public ServletTraceResult(List<ComponentExecutionStep> executionSteps, 
                            ServletSecurityAssessment securityAssessment) {
    ...
    public String toJsonString() {
        ...
        json.append("\"componentType\":\"servlet\",");
    ...
    public ServletSecurityAssessment getSecurityAssessment() { return securityAssessment; }
